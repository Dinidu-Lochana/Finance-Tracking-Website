...
const list = document.getElementById("transactionlist"); // Added missing ID
...
function drawpiechart() {
    ...
    var data = {
        labels: ['Food', 'Transport', 'Education', 'Utilities', 'Other Expense'],
        datasets: [{
            data: [foodTotal, transportTotal, educationTotal, utilitiesTotal, otherexpenseTotal],
            backgroundColor: ['#2adece', '#dd3b79', '#ff766b', '#dbf300', '#04f123']
        }]
    };
